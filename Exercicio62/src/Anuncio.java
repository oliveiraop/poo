...
public class Anuncio {
    ...
    public Anuncio(String titulo, float preco, boolean ativo, Assinante assinante, ArrayList<Livro> livros) {
        this.titulo = titulo;
        this.preco = preco;
        this.ativo = ativo;
    ...
    public Anuncio(String titulo, float preco, boolean ativo, Assinante assinante) {
        this(titulo, preco, ativo, assinante, new ArrayList<Livro>());
    }
